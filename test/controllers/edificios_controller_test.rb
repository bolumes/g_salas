...
class EdificiosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create edificio" do
    assert_difference("Edificio.count") do
      post edificios_url, params: { edificio: { localiza: @edificio.localiza, nome: @edificio.nome } }
    end
  ...
  test "should update edificio" do
    patch edificio_url(@edificio), params: { edificio: { localiza: @edificio.localiza, nome: @edificio.nome } }
