...
class DocentesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create docente" do
    assert_difference("Docente.count") do
      post docentes_url, params: { docente: { email: @docente.email, nome: @docente.nome, telefone: @docente.telefone } }
    end
  ...
  test "should update docente" do
    patch docente_url(@docente), params: { docente: { email: @docente.email, nome: @docente.nome, telefone: @docente.telefone } }
